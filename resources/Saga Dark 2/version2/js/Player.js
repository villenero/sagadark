...
function Player()
{
    ...
    */
    this.startupPlayer = function(level)
    {
        ...
        this.startupAnimatedGameObject(g_ResourceManager.idleRight, 140, 100, 4, 6, 8);
        this.level = level;
        return this;
    }
    ...
    */
    this.keyDown = function(event)
    {
        ...
        // right
        if ((event.keyCode == 39 || event.keyCode == 83) && !this.right)
        {
            this.right = true;
            updateRequired = true;
        }
    ...
    */
    this.keyUp = function(event)
    {
        ...
        {
            this.left = false;
            this.setAnimation(g_ResourceManager.idleLeft, 6, 8);
        }
        // right
        if (event.keyCode == 39 || event.keyCode == 83)
        {
            this.right = false;
            this.setAnimation(g_ResourceManager.idleRight, 6, 8);
        }
    ...
    */
    this.updateAnimation = function()
    {
       if (this.right && this.left)
            ...
            this.setAnimation(g_ResourceManager.runRight, 6, 8);
        else if (this.left)
            this.setAnimation(g_ResourceManager.runLeft, 6, 8);
    }
