...
function Player()
{
    ...
    */
    ...
    {
    		//function(/**Image*/ image, /**Number*/ x, /**Number*/ y, /**Number*/ z, /**Number*/ frameCount, /**Number*/ fps)
        this.startupAnimatedGameObject(g_idle_right, 140, 100, 4, 6, 8);
        this.level = level;
        return this;
    }
    ...
    */
    this.keyUp = function(event)
    {
        ...
        {
            this.left = false;
            this.setAnimation(g_idle_left, 6, 8);
        }
        // right
        if (event.keyCode == 39)
        {
            this.right = false;
            this.setAnimation(g_idle_right, 6, 8);
        }
    ...
    */
    this.updateAnimation = function()
    {
       if (this.right && this.left)
            ...
            this.setAnimation(g_run_right, 6, 8);
        else if (this.left)
            this.setAnimation(g_run_left, 6, 8);
    }
	...
	this.update = function (/**Number*/ dt, /**CanvasRenderingContext2D*/context, /**Number*/ xScroll, /**Number*/ yScroll)
    {
        ...
        if ((this.right || this.left) && !(this.left && this.right))
        {
            ...
            do
            {
                ...
                // from the "sky" down).
                var playerHeight = 304 - (this.y + this.image.height); //context.canvas.height - (this.y + this.image.height);
        ...
        {
            this.y = 304 - maxGroundHeight - this.image.height; //context.canvas.height - maxGroundHeight - this.image.height;
            this.grounded = true;
            this.jumpSinWavePos = 0;
        }
