    ...
    */
    this.startupGameObjectManager = function()
    {
        ...
        new ResourceManager().startupResourceManager([
            {name: 'runLeft', src: 'gfx/run_left.png'},
            {name: 'runRight', src: 'gfx/run_right.png'},
            {name: 'idleLeft', src: 'gfx/idle_left.png'},
            {name: 'idleRight', src: 'gfx/idle_right.png'},
            {name: 'background0', src: 'gfx/plano0.png'},
            {name: 'background1', src: 'gfx/plano1.png'},
            {name: 'background2', src: 'gfx/plano2.png'},
            {name: 'block', src: 'gfx/BlockA0.png'},
            {name: 'gem', src: 'gfx/Gem.png'},
            {name: 'mainmenu', src: 'gfx/mainmenu.png'},
            {name: 'portal', src: 'gfx/portal.png'}]);
